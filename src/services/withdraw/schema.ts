...
export type WithdrawQuoteResultInternal = WithdrawQuoteSuccessInternal | WithdrawQuoteErrorInternal;
...
export type WithdrawSubmitResponse = z.infer<typeof withdrawSubmitResponseSchema>;
